...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xaowi0315', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '智联·未来家', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'XAOWI.CLICK', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '智能家居与生活革新指南', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '探索未来科技与生活美学，打造全场景智能家居解决方案，让家更懂你。🎉',
